...
status: active
last_updated: 2026-05-03
next_action: Alan tags 123 pieces in tag-pieces.html (file://, single sitting or split). Then Cowork to merge `character` column into work/pieces.csv, author work/expected_layers.yaml v1 around defaults_by_character, and finalize CODE_PROMPT_dashboard-and-audit-v2.md. Then Code session to ship audit extension + dashboard.html.
```
