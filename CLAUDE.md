...
| Source pieces — gen-2 per-piece archive (`source/pieces/`) | 🔄 First batch ingested 2026-04-30: **97 of 123 captured** (95 numeric + 092a + 112a). 26 still pending — see `sessions/2026-04-30-2359_cowork_inbox-ingest.md`. Effective DPI verified at ~613 from a ruler measurement on piece 002 (above the 600-DPI spec). |
