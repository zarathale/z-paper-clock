...
next_action: Send `CODE_PROMPT_preview-html-guided-stepper.md` to Code (ready-for-code). In parallel: fix 068 fold authoring (missing pane→c1 fold line) and use snap to position remaining anchor cluster pieces now that bridge-save is live.
```
